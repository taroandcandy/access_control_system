...
class Face_Register:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "FPS:   " + str(self.fps.__round__(2)), (20, 100), self.font, 0.8, (0, 255, 0), 1,cv2.LINE_AA)
    ...
    def process(self, stream):
        ...
        while stream.isOpened():
            flag, img_rd = stream.read()        # 获取摄像机视频流  / Get camera video stream
            kk = cv2.waitKey(1)
            faces = detector(img_rd, 0)         # 使用Dlib人脸检测器 / Use Dlib face detector
