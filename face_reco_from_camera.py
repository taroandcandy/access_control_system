...
class Face_Recognizer:
    ...
    def return_euclidean_distance(feature_1, feature_2):
        ...
        feature_1 = feature_1.astype('float64')
        feature_2 = np.array(feature_2)
        feature_2 = feature_2.astype('float64')
    ...
    def show_chinese_name(self):
        ...
        if self.current_frame_face_cnt >= 1:
            self.name_known_list[0] ='徐欢'.encode('utf-8').decode()
            # self.name_known_list[1] ='66'.encode('utf-8').decode()
            # self.name_known_list[2] ='尹国安'.encode('utf-8').decode()
            # self.name_known_list[3] ='谭浩'.encode('utf-8').decode()
            # self.name_known_list[4] ='陈榆林'.encode('utf-8').decode()
                        ...
                        for k in range(len(faces)):
                            ...
                            for i in range(len(self.feature_known_list)):
                                ...
                                if str(self.feature_known_list[i][0]) != '0.0':
                                    ...
                                    e_distance_tmp = self.return_euclidean_distance(self.current_frame_feature_list[k],self.feature_known_list[i])
